...
new features as they are needed, and remove them when they are no longer needs (more on that on a moment)
...
which are modeled as successive and bounded sequences of elements called chunks. 
...
a thread-like abstraction that is dramatically lighter than JVM threads. 
